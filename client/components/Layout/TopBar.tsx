...
export const TopBar: React.FC<TopBarProps> = ({ user, isDarkMode, toggleTheme, onOpenChat }) => {
  ...
  return (
    <header className="h-16 px-6 flex items-center justify-between flex-shrink-0 z-40 sticky top-0
      ...
      <div className="flex items-center gap-3" ref={containerRef}>
        ...
        <span className="text-[10px] text-slate-400 font-mono hidden sm:inline-block">v2.1</span>
        ...
        <div className="flex items-center gap-1 relative">
          ...
          <div className="relative">
            ...
            {activePanel === 'notifications' && (
              <div className="absolute top-full left-0 mt-3 w-80 sm:w-96 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-left flex flex-col max-h-[500px]">

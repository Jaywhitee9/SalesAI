...
import { NewLeadDrawer } from './NewLeadDrawer'; // Import
...
export const LeadsDashboard: React.FC<LeadsDashboardProps> = ({ isDarkMode }) => {
  ...
  const handleSaveNewLead = (newLeadData: Partial<Lead>) => {
    // In a real app, this would dispatch an action or call API
    // For now, we just log and close (the component handles visual close)
    console.log("Saving new lead:", newLeadData);
    // You would typically update the MOCK_LEADS or fetch leads again here
    // alert('הליד נוסף בהצלחה (Mock)'); 
  };
          ...
          <div className="flex items-center gap-3 w-full md:w-auto flex-1 relative z-20">
             ...
             <div className="hidden md:flex items-center gap-2">
                ...
                <button 
                  ...
                  disabled={selectedStatuses.length === 0 && selectedOwner === 'all'}
                >
                  נקה הכל
                </button>
             </div>
